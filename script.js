...
const firebaseConfig = {
  apiKey:            "AIzaSyD3Ug4WU_XZBU5bGJMndNiH_qoermFSAQo",
  authDomain:        "jims-cfa1a.firebaseapp.com",
  projectId:         "jims-cfa1a",
  storageBucket:     "jims-cfa1a.firebasestorage.app",
  messagingSenderId: "917261620562",
  appId:             "1:917261620562:web:2f9aecad952427dbf2968b",
  measurementId:     "G-CQPHESKFR6"
};
...
function validateLogin() {
  ...
  if (!user || !pass || !input) { alert('Please fill all fields'); return; }
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (userTypeEl) {
    userTypeEl.addEventListener('change', toggleOTPSection);
    toggleOTPSection();
  }
